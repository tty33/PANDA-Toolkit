# Train with PANDA IMAGE datasets

In this note, you will know how to finetune faster rcnn model with PANDA IMAGE datasets. 
...
We need to reorganize the dataset into COCO format. Please refer to [PANDA-Toolkit](https://github.com/GigaVision/PANDA-Toolkit) for details.
